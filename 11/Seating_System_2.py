...
def check_direction(input_list, row_number, col_number, max_row_number, max_col_number, row_direction=0, col_direction=0):
    current_row = row_number
    current_col = col_number
    while current_row >= 0 and current_col >= 0 and current_row <= max_row_number and current_col <= max_col_number:
        current_row += row_direction
        current_col += col_direction
        if current_row < 0 or current_col < 0 or current_row > max_row_number or current_col > max_col_number:
            break 
        if (input_list[current_row][current_col] == 'L'):
            return False
        elif (input_list[current_row][current_col] == '.'):
            pass
        elif (input_list[current_row][current_col] == '#'):
            return True    
...
def get_surrounding_seat_info(input_list, row_number, col_number, max_row_number, max_col_number):
    ...
    # Check left
    if (check_direction(input_list, row_number, col_number, max_row_number, max_col_number, row_direction=0, col_direction=-1)):
    ...
    # Check up
    if (check_direction(input_list, row_number, col_number, max_row_number, max_col_number, row_direction=-1, col_direction=0)):
        num_occupied_seats += 1
    ...
    # Check (left, up)
    if (check_direction(input_list, row_number, col_number, max_row_number, max_col_number, row_direction=-1, col_direction=-1)):
        num_occupied_seats += 1
...
def update_seat_info(input_list, row_number, col_number, num_occupied_seats):
    ...
    if current_state == '.':
        ...
        new_state = '#'
    elif current_state == '#' and num_occupied_seats >= 5:
        new_state = 'L'
    else:
